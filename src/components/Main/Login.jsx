            ...
            <>
                ...
                <form onSubmit={handleStage1} className={'login-form'}>
                    ...
                    <div className="register-redirect">
                        <span className="grayed">Not a user yet?</span> <span className="pseudolink">Register</span>
                    </div>
                </form>
            </>
        )
